...
var showQuestion = function(question) {
	...
	asker.html('<p>Name: <a class="link" target="_blank" '+
...
var showAnswer = function(answer) {
	...
	// Set the question properties in result
	var answerElem = result.find('.username a');
	answerElem.attr('href', answer.user.link);
	answerElem.text(answer.user.display_name);

	// Set the users score.
	var answerScore = result.find('.score');
		answerScore.text(answer.score);

	var answerImage = result.find('.profilePic');
	answerImage.attr('src', answer.user.profile_image);
